...

{
  ...
  /*class CartProduct {
    constructor(menuProduct, elelment) {
    ...
    getElements(element){
      ...
      thisCartProduct.dom.remove = thisCartProduct.doom.wrapper.querySelector(select.cartProduct.remove);
    }
  }*/
